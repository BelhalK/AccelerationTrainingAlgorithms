...
r1 <- buildmlx(project="project01_Vini10_Annealing.mlxtran")
...
r2 <- buildmlx(project="project01_Vini10_Annealing.mlxtran", paramToUse=c("V", "Cl"), covToTransform="all")
# Only the covariate model will be built, using AIC instead of BIC:
r3 <- buildmlx(project="project01_Vini10_Annealing.mlxtran", model="covariate", criterion="AIC")
