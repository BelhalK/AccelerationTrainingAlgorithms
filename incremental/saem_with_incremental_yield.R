...
#ref (map always)
options.incremental<-list(seed=39546,map=F,fim=F,ll.is=F,nb.chains = 1, nbiter.mcmc = c(2,2,2),nbiter.saemix = c(K1,K2),nb.replacement=100)
...
comparison <- rbind(theo_ref,theo_incremental,theo_mix)
