...
graphConvMC_twokernels(post_nest[[index]][,-c(3,4)],post_mala[[index]][,-c(3,4)])


graphConvMC_twokernels(post_mala[[index]],post_nest[[index]], title="MALA vs NEST")
graphConvMC_threekernels(post_nest[[index]],post_mala[[index]],post_nest[[index]], title="EM")
...
graphConvMC_threekernels(final_nest,final_mala,final_nest, title="EM")
...
graphConvMC_new(post_nest[[1]], title="EM")

graphConvMC_twokernels(final_nest,final_mala, title="EM")
graphConvMC_threekernels(final_rwm,final_mala,final_nest, title="EM")
graphConvMC_twokernels(post_nest[[1]],post_mala[[1]], title="EM")
