...
source('graphplot.R') 
###RTTE
timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Desktop/research/CSDA/csda_new2/rtte3se.csv", header=T, sep=",")
...
for (m in 1:replicate){
  ...
  c("lambda","beta"))), 
  transform.par=c(1,1),omega.init=matrix(c(1/m,0,0,1/m),ncol=2, 
  byrow=TRUE))
  ...
  options.new<-list(seed=39546,map=F,fim=F,ll.is=F,nb.chains = 1, nbiter.mcmc = c(0,2,2,2),
    nbiter.sa=0,nbiter.saemix = c(K1,K2),displayProgress=FALSE, map.range=c(1:12),nbiter.burn =0)
...
writeDatamlx(res, result.file = "/Users/karimimohammedbelhal/Desktop/research/CSDA/csda_new2/rtte3se.csv")
head(read.table("/Users/karimimohammedbelhal/Desktop/research/CSDA/csda_new2/rtte3se.csv", header=T, sep=","))
  timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Desktop/research/CSDA/csda_new2/rtte3se.csv", header=T, sep=",")
  timetoevent.saemix <- timetoevent.saemix[timetoevent.saemix$ytype==2,]
  ...
  options.mix<-list(seed=seed0,map=F,fim=F,ll.is=F,nb.chains = 1, nbiter.mcmc = c(2,2,2,6),nbiter.saemix = c(K1,K2),nbiter.sa=0,displayProgress=FALSE, map.range=c(1:4),nbiter.burn =0)
