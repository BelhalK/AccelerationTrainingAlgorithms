...
nb.samples <- nrow(SAMU_NEW)
nb.cov <- ncol(SAMU_NEW)
...
#Incremental MCEM
list.imcem = miss.saem(X.obs,y,maxruns=N*nb.epochs,ll_obs_cal=FALSE, algo = "imcem", batchsize= batchsize)
...
save(N, nb.iter, batchsize,list.saem,list.mcem,list.imcem,list.imcem10,list.imcem50, file = "trauma_all.RData")
