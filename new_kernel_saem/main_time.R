...
#' 
#' @export saemix
saemix_time_mamyula<-function(model,data,control=list()) {
...
# Burn-in - resetting sufficient statistics
  ...
  # E-step
  xmcmc<-estep_time_mamyula(kiter, Uargs, Dargs, opt, structural.model, mean.phi, varList, DYF, phiM,saemixObject)
  # if(kiter>48) browser()
