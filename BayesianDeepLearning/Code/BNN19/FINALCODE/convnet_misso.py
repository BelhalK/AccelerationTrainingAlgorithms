...
def run_experimentmisso(average_gradients, batch_size, iterations, verbose):
  batch_size = batch_size
  tf.reset_default_graph()
  net = ConvNetMISSO()
...
misso = run_experimentmisso(average_gradients=1, batch_size = batch_size, iterations=iterations, verbose= True)
