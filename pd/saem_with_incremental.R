...
#RWM
options<-list(seed=39546,map=F,fim=F,ll.is=F,nb.chains = 1, nbiter.mcmc = c(2,2,2),nbiter.saemix = c(K1,K2),nb.replacement=100,displayProgress=FALSE)
theo_ref<-data.frame(incremental_saemix(saemix.model,saemix.data1,options))
