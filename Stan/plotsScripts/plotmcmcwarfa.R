...
colnames(quantref) <- colnames(quantnew)<-c("iteration","ka","V","k","quantile")
save1 = plotq1(quantnew[,c(1,2,5)],quantmala[,c(1,2,5)])
save2 = plotq2(quantnew[,c(1,3,5)],quantmala[,c(1,3,5)])
save3 = plotq3(quantnew[,c(1,4,5)],quantmala[,c(1,4,5)])
save <- grid.arrange(save1,save2,save3, ncol=3)
ggsave(save, file="newpics/quantmala.pdf", width = 900, height = 450, units = "mm")

save1 = plotq1(quantnew[,c(1,2,5)],quantnuts[,c(1,2,5)])
save2 = plotq2(quantnew[,c(1,3,5)],quantnuts[,c(1,3,5)])
save3 = plotq3(quantnew[,c(1,4,5)],quantnuts[,c(1,4,5)])
save <- grid.arrange(save1,save2,save3, ncol=3)
ggsave(save, file="newpics/quantnuts.pdf", width = 900, height = 450, units = "mm")


save1 = plotq1(quantnew[,c(1,2,5)],quantadvi.full[,c(1,2,5)])
save2 = plotq2(quantnew[,c(1,3,5)],quantadvi.full[,c(1,3,5)])
save3 = plotq3(quantnew[,c(1,4,5)],quantadvi.full[,c(1,4,5)])
save <- grid.arrange(save1,save2,save3, ncol=3)
ggsave(save, file="newpics/quantadvi_full.pdf", width = 900, height = 450, units = "mm")

save1 = plotq1(quantnew[,c(1,2,5)],quantadvi.onlymuvi[,c(1,2,5)])
save2 = plotq2(quantnew[,c(1,3,5)],quantadvi.onlymuvi[,c(1,3,5)])
save3 = plotq3(quantnew[,c(1,4,5)],quantadvi.onlymuvi[,c(1,4,5)])
save <- grid.arrange(save1,save2,save3, ncol=3)
ggsave(save, file="newpics/quantadvi_onlymuvi.pdf", width = 900, height = 450, units = "mm")

save1 = plotq1(quantnew[,c(1,2,5)],quantadvi.onlygammavi[,c(1,2,5)])
save2 = plotq2(quantnew[,c(1,3,5)],quantadvi.onlygammavi[,c(1,3,5)])
save3 = plotq3(quantnew[,c(1,4,5)],quantadvi.onlygammavi[,c(1,4,5)])
save <- grid.arrange(save1,save2,save3, ncol=3)
