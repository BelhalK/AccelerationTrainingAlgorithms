...
setwd("/Users/karimimohammedbelhal/Documents/GitHub/saem/laplacecoupled_saem")

source('main_coupling.R')
source('main_estep_coupling.R')
...
theo_new_ref<-data.frame(saemix_coupling(saemix.model,saemix.data,options.new))
...
theo_laplace<-data.frame(saemix_coupling(saemix.model,saemix.data,options.laplace))
