...
warfa_data <- read.table("/Users/karimimohammedbelhal/Documents/GitHub/saem/PackageContributions/SaemixNoncontinuousExtension/data/warfarin_data.txt", header=T)
...
###RTTE
timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Documents/GitHub/saem/PackageContributions/SaemixNoncontinuousExtension/data/rttellis.csv", header=T, sep=",")
# timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Desktop/R_Package/package_contrib/saemixB/data/rttellis.csv", header=T, sep=",")
