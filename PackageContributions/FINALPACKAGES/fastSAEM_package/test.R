...
setwd("/Users/karimimohammedbelhal/Desktop/Package/package_contrib_enhanced/saemixB/R")
...
setwd("/Users/karimimohammedbelhal/Desktop/Package/package_contrib_enhanced/saemixB")
warfa_data <- read.table("/Users/karimimohammedbelhal/Desktop/Package/package_contrib/saemixB/data/warfarin_data.txt", header=T)
...
###RTTE
timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Desktop/Package/package_contrib/saemixB/data/rtte_data.csv", header=T, sep=",")
...
#Warfarin
options_warfa<-list(seed=39546,map=F,fim=F,ll.is=T,print.is=TRUE,nbiter.mcmc = c(2,2,2,0),nb.chains=1, nbiter.saemix = c(K1,K2),nbiter.sa=0,displayProgress=TRUE,nbiter.burn =0, map.range=c(0))
...
rttenew<-saemix(saemix.model_rtte,saemix.data_rtte,options_rttenew)
