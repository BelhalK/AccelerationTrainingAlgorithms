# R CMD build saemixB
install.packages("~/saemixB_0.1.tar.gz", repos = NULL, type = "source")
library(saemixB)
...
timetoevent.saemix <- read.table("/Users/karimimohammedbelhal/Desktop/saemixB/data/rttellis.csv", header=T, sep=",")
