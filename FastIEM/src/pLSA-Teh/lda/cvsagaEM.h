...
#ifndef DSLDA_CVSAGAEM_H
#define DSLDA_CVSAGAEM_H
...
class CVSAGAEM : public BaseLDA {
public:
    CVSAGAEM(Corpus &corpus, Corpus &to_corpus, Corpus &th_corpus,
