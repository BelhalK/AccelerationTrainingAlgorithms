...
list.imcem10 = miss.saem(X.obs,y,maxruns=nb.iter,ll_obs_cal=FALSE, algo = "imcem", batchsize= N/10)

save(N, nb.iter, batchsize,list.saem,list.mcem,list.imcem,list.imcem10, file = "trauma.RData")
