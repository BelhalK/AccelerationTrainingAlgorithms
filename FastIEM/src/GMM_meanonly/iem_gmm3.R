...
variance <- rbind(oemvr[2:K,c(1,5,8)],iem[2:K,c(1,5,8)],oem[2:K,c(1,5,8)],em_scaled[2:K,c(1,5,8)])
# variance <- rbind(oemvr[1000:2000,c(1,5,8)],iem[1000:2000,c(1,5,8)],oem[1000:2000,c(1,5,8)],em_scaled[1000:2000,c(1,5,8)])
