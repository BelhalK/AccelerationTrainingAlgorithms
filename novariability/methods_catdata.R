...
for (j in 1:replicate){
  ...
  logistic_optim<-data.frame(saemix(saemix.model,saemix.data,options_logistic_with))
  ...
  logistic_withav<-data.frame(saemix(saemix.model,saemix.data,options_logistic_with))
  ...
  logistic_newkernelav<-data.frame(saemix(saemix.model,saemix.data,options_newkernel))
  ...
  logistic_bayes<-data.frame(saemix(saemix.model,saemix.data,options_logistic_with))
